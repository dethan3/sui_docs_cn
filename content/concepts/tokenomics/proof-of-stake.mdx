...
This section covers how the different components of the Sui economy interact with each other to introduce the Sui DPoS system. For reference, see the Staking and Tokenomics diagram in the [Sui Tokenomics](../tokenomics.mdx) overview.

The Sui economic model works as follows:

At the beginning of each epoch, three important events happen:

- SUI holders stake (some) of their tokens to validators and a new [committee](../../guides/operator/validator-committee.mdx) is formed.
- The reference gas prices are set as described in [Sui Gas Pricing](./gas-pricing.mdx).
